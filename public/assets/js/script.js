...
$(function(){
  // Cart drawer toggle with active state
  function openCart() {
    $(".cartcanvas__info").addClass("info-open");
    $(".offcanvas__overlay").addClass("overlay-open");
    $(".bb-cart-toggle").addClass("active-cart");
  }

  function closeCart() {
    $(".cartcanvas__info").removeClass("info-open");
    $(".offcanvas__overlay").removeClass("overlay-open");
    $(".bb-cart-toggle").removeClass("active-cart");
  }
  ...
  $('.ui-btn').on("click", function(e) {
    e.preventDefault();
    e.stopPropagation();
    const isOpen = $(".cartcanvas__info").hasClass("info-open");
    if (isOpen) {
      closeCart();
    } else {
      openCart();
