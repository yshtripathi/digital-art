...
return [
    ...
    'head' => [
        'site'        => '[Website Name]',
        'home'        => ':site — Online Courses by Level',
        'description' => 'Online courses sorted into categories and split into levels. Pick the level that matches what you know, unlock it with credits and learn at your own pace.',
    ...
    'footer' => [
        ...
        'news_title'   => 'Hear about new courses first',
        'news_desc'    => 'Add your email address and we will let you know when new courses and levels are published. Every message is short and quick to read.',
        'news_points'  => [
            'courses' => 'New courses and levels as soon as they open',
            'lessons' => 'Improvements to the lessons you are already taking',
            'tips'    => 'Simple ideas for deciding what to learn next',
        ],
        ...
        'about'        => 'Every subject here is divided into levels, so the next step is always clear. Start where your knowledge runs out, take the level that suits you today, and come back for the one after it when you are ready.',
    ...
    'home' => [
        'meta'           => 'Browse courses by category, compare the levels inside each course, and unlock the level you want with credits.',

        // Hero
        'hero_eyebrow'   => 'Online learning platform',
        'hero_title'     => 'Learn one level at a time',
        'hero_desc'      => 'Every subject sits in a category, every course is split into levels, and you unlock only the levels you pick. All of it is open to read before you spend anything.',
        ...
        'featured_desc'  => 'A few of the courses open at the moment. Each card shows the levels inside and what the first one costs in credits.',
        ...
        'steps_desc'     => 'Every course is reached the same way, so there is nothing new to work out when you move on to another subject.',
    ...
    'login' => [
        'title'        => 'Login',
        'aside'        => 'Log in to open the levels you have unlocked, check your credit balance and carry on from the point you stopped at.',
        'label'        => 'Welcome Back',
    ...
    'forgot' => [
        ...
        'aside'       => 'Enter the email address you registered with and we will send you a link for setting a new password.',
    ...
    'about' => [
        ...
        'why_p1'       => 'This platform exists to make structured learning easy to approach. Every course sits in one catalogue, so you can look through the subjects on offer, open whichever interests you and read exactly what it covers before you decide anything.',
