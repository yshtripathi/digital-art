    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'string'   => 'お名前を入力してください。',
            'min'      => 'お名前は:min文字以上で入力してください。',
        ],
        'email' => [
            'required' => 'メールアドレスを入力してください。',
            'string'   => '有効なメールアドレスを入力してください。',
            'email'    => '有効なメールアドレスを入力してください。',
            'unique'   => 'このメールアドレスはすでに登録されています。ログインしてください。',
        ],
        'password' => [
        ...
        'new_confirm_password' => [
            'same' => '入力されたパスワードが一致しません。',
        ],
        'captcha' => [
            'required' => '画像に表示されたセキュリティコードを入力してください。',
            'captcha'  => 'セキュリティコードが正しくありません。新しいコードでもう一度お試しください。',
        ],
    ],
