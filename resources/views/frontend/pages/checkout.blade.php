            ...
            <div class="ag-checkout-grid">
                ...
                <div class="ag-checkout-main">
                    ...
                    <div class="ag-text-block">
                        <h3 class="ag-card-title"><i class="fas fa-user-circle"></i> {{ __('inkwave.checkout_billing') }}</h3>
                        
                        <div class="ag-field-grid">
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_fname') }} *</label>
                                <input type="text" name="first_name" id="first_name" value="" placeholder="{{ __('inkwave.checkout_ph_fname') }}" class="ag-input">
                                @error('first_name')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_lname') }} *</label>
                                <input type="text" name="last_name" id="last_name" value="" placeholder="{{ __('inkwave.checkout_ph_lname') }}" class="ag-input">
                                @error('last_name')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_email') }} *</label>
                                <input name="email" type="email" id="email" value="{{ auth()->user()->email ?? '' }}" placeholder="{{ __('inkwave.checkout_ph_email') }}" class="ag-input">
                                @error('email')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_phone') }} *</label>
                                <input type="tel" name="phone" id="phone" placeholder="{{ __('inkwave.checkout_ph_phone') }}" value="{{ auth()->user()->phone ?? '' }}" class="ag-input" pattern="[\d\+\-\(\)\s]{7,}" oninput="this.value = this.value.replace(/[^\d\+\-\(\)\s]/g, '')" inputmode="tel">
                                @error('phone')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field ag-field--full">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_address') }} *</label>
                                <input type="text" name="address1" id="address" value="{{ auth()->user()->address ?? '' }}" placeholder="{{ __('inkwave.checkout_ph_address') }}" class="ag-input">
                                @error('address1')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_city') }} *</label>
                                <input type="text" name="city" id="city" value="{{ auth()->user()->city ?? '' }}" placeholder="{{ __('inkwave.checkout_ph_city') }}" class="ag-input">
                                @error('city')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_zip') }} *</label>
                                <input type="text" name="post_code" id="post_code" pattern="[0-9]*" placeholder="{{ __('inkwave.checkout_ph_zip') }}" value="{{ auth()->user()->zip ?? '' }}" class="ag-input">
                                @error('post_code')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_state') }} *</label>
                                <input type="text" name="state" id="state" value="{{ auth()->user()->state ?? '' }}" placeholder="{{ __('inkwave.checkout_ph_state') }}" class="ag-input">
                                @error('state')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_country') }} *</label>
                                <select name="country" id="country" class="ag-select">
                                    <option value="">{{ __('inkwave.checkout_ph_country') }}</option>
                    ...
                    {{-- Additional info --}}
                    <div class="ag-text-block">
                        <h3 class="ag-card-title"><i class="fas fa-clipboard-list"></i> {{ __('inkwave.checkout_add_info') }}</h3>
                        <div class="ag-field">
                            <label class="ag-label">{{ __('inkwave.checkout_lbl_notes') }}</label>
                            <textarea name="note" placeholder="{{ __('inkwave.checkout_ph_notes') }}" class="ag-textarea"></textarea>
                        </div>
                    </div>

                    {{-- Card details --}}
                    <div class="ag-text-block">
                        <h3 class="ag-card-title"><i class="fas fa-credit-card"></i> {{ __('inkwave.checkout_card_details') }}</h3>
                        
                        <div class="ag-field-grid">
                            <div class="ag-field ag-field--full">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_card_name') }}</label>
                                <input type="text" name="name" id="name_on_card" class="ag-input" placeholder="{{ __('inkwave.checkout_ph_card_name') }}">
                                @error('name')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field ag-field--full">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_card_num') }}</label>
                                <input type="text" name="card_number" id="card_number" placeholder="{{ __('inkwave.checkout_ph_card_num') }}" class="ag-input cc-number" pattern="[0-9\s]{19}" inputmode="numeric" maxlength="19" autocomplete="cc-number">
                                @error('card_number')<span class="ag-error-msg">{{ $message }}</span>@enderror
                            </div>
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_exp_month') }}</label>
                            ...
                            <div class="ag-field">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_cvv') }}</label>
                    ...
                    {{-- Terms --}}
                    <div class="ag-text-block">
                        <h3 class="ag-card-title"><i class="fas fa-file-signature"></i> {{ __('inkwave.checkout_terms') }}</h3>

                        <div class="ag-check-field">
                            <label class="ag-checkbox-wrap">
                                <input type="checkbox" id="terms" name="terms">
                                <span class="ag-checkbox-mark"></span>
                                <span>{{ __('inkwave.checkout_agree_terms') }} <a href="{{ route('pages', 'terms-conditions') }}" target="_blank">{{ __('inkwave.checkout_link_terms') }}</a></span>
                            </label>
                        ...
                        <div class="ag-check-field">
                            <label class="ag-checkbox-wrap">
                                ...
                                <span class="ag-checkbox-mark"></span>
                                <span>{{ __('inkwave.checkout_agree_privacy') }} <a href="{{ route('pages', 'privacy-policy') }}" target="_blank">{{ __('inkwave.checkout_link_privacy') }}</a></span>
                            </label>
                        ...
                        <div class="ag-check-field">
                            <label class="ag-checkbox-wrap">
                                ...
                                <span class="ag-checkbox-mark"></span>
                                <span>{{ __('inkwave.checkout_agree_delivery') }} <a href="{{ route('pages', 'delivery-policy') }}" target="_blank">{{ __('inkwave.checkout_link_delivery') }}</a></span>
                            </label>
                        ...
                        <div class="ag-check-field">
                            <label class="ag-checkbox-wrap">
                                ...
                                <span class="ag-checkbox-mark"></span>
                                <span>{{ __('inkwave.checkout_agree_refund') }} <a href="{{ route('pages', 'refund-policy') }}" target="_blank">{{ __('inkwave.checkout_link_refund') }}</a></span>
                            </label>
                ...
                <aside class="ag-checkout-aside">
                    <div class="ag-text-block ag-order-summary">
                        <h3 class="ag-card-title"><i class="fas fa-shopping-bag"></i> {{ __('inkwave.checkout_your_order') }}</h3>
                            ...
                            @if(Helper::getAllProductFromCart())
                                @foreach(Helper::getAllProductFromCart() as $key => $cart)
                                    ...
                                    <div class="ag-order-row">
                                        <span class="ag-points"><i class="fas fa-coins"></i> {{ number_format($points, 0, '.', ',') }} {{ __('inkwave.checkout_points') }}</span>
                        ...
                        @if(env('CAPTCHA_ENABLED', true))
                            <div class="ag-field" style="margin-top: 32px;">
                                <label class="ag-label">{{ __('inkwave.checkout_lbl_sec') }} *</label>
                                
                                <div class="ag-captcha-stretch" style="margin-bottom: 16px; border: 1px solid rgba(0,0,0,0.15);">
                                    @captcha
                                </div>
                                <input type="text" id="captcha" name="captcha" autocomplete="off" placeholder="{{ __('inkwave.checkout_ph_sec') }}" class="ag-input">
                                @error('captcha')<span class="ag-error-msg">{{ __('inkwave.checkout_err_captcha') }}</span>@enderror
                            </div>
                        @endif

                        <button type="submit" class="ag-submit-btn" id="button-confirm">{{ __('inkwave.checkout_btn_place') }}</button>
                        <a href="{{ route('home') }}" class="ag-ghost-btn">{{ __('inkwave.checkout_btn_continue') }}</a>
