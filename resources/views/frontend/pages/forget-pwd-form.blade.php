...
@include('frontend.layouts.breadcrumb', [
    'title' => __('inkwave.forgot_title'),
    'links' => [
        ['name' => __('inkwave.menu_home'), 'url' => route('home')],
        ['name' => __('inkwave.forgot_title')]
    ]
])
    ...
    <div class="duo-container">
        <div class="duo-auth-card">
            ...
            <div class="duo-form-head">
                <p class="duo-eyebrow">{{ __('inkwave.forgot_badge') }}</p>
                <h1 class="duo-title">{{ __('inkwave.forgot_title') }}</h1>
            </div>
            ...
            <form name="frmForgot" id="frmForgot" action="{{ route('password.email') }}" method="post">
                ...
                <button type="submit" name="submit-form" class="duo-submit"><i class="fas fa-envelope-open"></i> {{ __('inkwave.btn_forgot') }}</button>
            </form>
