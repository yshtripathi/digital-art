...
<section class="auth-section" style="background: linear-gradient(135deg, #FFF4EE 0%, #FFE5F1 50%, #FFF4EE 100%); padding: 6rem 60px !important;">
    <div class="auto-container">
        <div class="row align-items-center g-5" style="max-width: 650px; margin-left: auto; margin-right: auto;">
            <div class="col-12">
                <div class="auth-card border-0 shadow-xl overflow-hidden" style="background: rgba(255, 255, 255, 0.6); backdrop-filter: blur(20px); border-radius: 20px; border: 1px solid rgba(232, 93, 142, 0.1);">
                    ...
                    <div class="auth-card-header p-5 text-center" style="border-bottom: 1px solid rgba(232, 93, 142, 0.1);">
                        ...
                        <span class="modern-badge" style="font-size: 11px; font-weight: 700; color: #E85D8E; background: rgba(232, 93, 142, 0.08); padding: 8px 14px; border-radius: 6px; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block;">{{ __('common.forgot_badge') }}</span>
                        <h2 class="modern-h2 mt-3 mb-3" style="font-size: 32px; font-weight: 900; color: #0a0e27;">{{ __('common.forgot_title') }}</h2>
                    </div>
                    ...
                    <div class="p-5">
                        <form name="frmLogin" id="frmLogin" action="{{route('password.email')}}" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row align-items-center g-3">
                                    <div class="col-md-8">
                                        <input type="text" id="captcha" name="captcha" autocomplete="off" class="form-control form-control-lg bg-white border-1 py-3 px-4 rounded-3" placeholder="{{ __('common.fill_captcha') }}" required style="border-color: rgba(232, 93, 142, 0.2); transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);">
                                    </div>
                            ...
                            <div class="mt-5">
                                <button class="btn-sakura w-100 py-3 fw-bold rounded-3" type="submit" name="submit-form" style="background: linear-gradient(135deg, #E85D8E 0%, #C86BFA 100%); color: white; border: none; border-radius: 16px; padding: 14px 32px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1); box-shadow: 0 4px 15px rgba(232, 93, 142, 0.3); font-size: 15px; letter-spacing: 0.5px;">
                                    <i class="fas fa-envelope-open"></i> {{ __('common.send_reset_link') }}
                                </button>
                            </div>
                        </form>
                        ...
                        <div class="text-center">
                            <p class="mb-0" style="font-size: 14px; color: #666;">
                                ...
                                <a href="{{route('login.form')}}" class="fw-bold text-decoration-none hover-underline" style="color: #E85D8E; transition: all 0.3s ease;">{{ __('common.forgot_sign_in_now') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
