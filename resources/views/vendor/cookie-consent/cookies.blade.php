{{-- ==========================================================================
     [Website Name] — Cookie Consent
     Floating dark card, bottom-left (see design and content/DESIGN.md).
     Styles: public/css/main.css
     ========================================================================== --}}

<aside id="ck-policy" class="ck" role="dialog" aria-labelledby="ck-title" data-text="{{ json_encode(__('cookieConsent::cookies.details')) }}">
    <div class="ck__scroll">
        <div class="ck__head">
            <span class="ck__icon" aria-hidden="true"><i class="fas fa-cookie-bite"></i></span>
            <h6 class="ck__title" id="ck-title">@lang('cookieConsent::cookies.title')</h6>
        </div>
        ...
        <a href="javascript:void(0)" class="ck__customize-toggle js-cookie-toggle" data-target="ck-policy-customize">
                ...
                <div class="ck__sections">
                    ...
                    <div class="ck__section">
                        <label for="ck-policy-check-{{ $category->key() }}" class="ck__category">
                            <strong class="ck__label">{{ $category->title }}</strong>
